...
<center>![](images/shinyLottie.gif){width="600"}</center>
...
-   `lottie_button()` converts a Lottie animation object into a button; this is behaviourally identical to Shiny's `actionButton()`
