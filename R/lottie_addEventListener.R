...
#'     \item{\code{custom_js}}{Custom JavaScript code to execute when the event is triggered.}
...
#' }
#'
#' @return If used within a reactive context, the function will execute the necessary JavaScript code. Otherwise, it will return a \code{script} tag containing the JavaScript code.
#'
